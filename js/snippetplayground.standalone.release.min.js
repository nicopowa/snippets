...
a.nextSibling);a=document.createElement("span");this.g.appendChild(a);var c=document.createElement("button");a.appendChild(c);c.addEventListener("click",()=>p(this));c=document.createElement("a");c.setAttribute("href","//snipp.et");c.setAttribute("target","_blank");a.appendChild(c);this.i=document.createElement("iframe");this.i.setAttribute("sandbox","allow-scripts");this.g.appendChild(this.i);this.l=document.createElement("div");this.g.appendChild(this.l);this.m=document.createElement("div");this.l.appendChild(this.m);
!1===b.body&&(this.g.className+=" snip-nobody");!1===b.console&&(this.g.className+=" snip-nocons");b=/(\d+)(\w+)?/.exec(b.height||12);this.i.style.height=this.l.style.minHeight=this.l.style.maxHeight="calc("+(b[2]?b.slice(1).join(""):b[1]+"em")+" + 0.5em)"}n.push(this)}}u(...a){let b=a.shift();if("perf"==b)return r(this,+a[0]);let c=new Date,d=document.createElement("span");d.className+=" snip-"+b;d.setAttribute("data-time",(new Date(c-6E4*c.getTimezoneOffset())).toISOString().slice(-13,-1));d.textContent=
a.join(" ");this.m.appendChild(d);this.l.scrollTo(0,this.l.scrollHeight)}get element(){return this.g}get s(){return this.B.innerText.replace(/\u200B/g,"")}}var u,n,v=t,w=["Snippet"],x=this||self;w[0]in x||"undefined"==typeof x.execScript||x.execScript("var "+w[0]);for(var y;w.length&&(y=w.shift());)w.length||void 0===v?x[y]&&x[y]!==Object.prototype[y]?x=x[y]:x=x[y]={}:x[y]=v;t.remove=function(a){var b=n.findIndex(c=>c.v===a);-1!==b&&(b=n.splice(b,1)[0],b.g&&b.g.parentNode.removeChild(b.g),b=null)};
u=0;n=[];window.addEventListener("message",a=>m(a),!1);window.addEventListener("load",()=>new A);function B(a,b,c){var d=document.createElement("div");d.classList.add("code-wrap");a.h.appendChild(d);a=document.createElement("pre");a.classList.add("prism-live");a.classList.add("line-numbers");a.classList.add("editor");d.appendChild(a);d=document.createElement("code");d.classList.add("code");d.classList.add("language-"+b);d.textContent=c;a.appendChild(d);new Prism.Live(a)}
