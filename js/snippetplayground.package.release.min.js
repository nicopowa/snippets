...
function v(a){a.I.addEventListener("click",()=>w(a));a.K.addEventListener("click",b=>"A"===b.target.nodeName&&w(a)&&x(a,b.target.href));a.B.addEventListener("click",b=>b.target.classList.contains("opt")&&y(a,b.target));a.l.addEventListener("click",b=>b.target.classList.contains("cmd")&&z(a,b.target));(new Map([[a.create,a.O],[a.U,a.V],[a.N,a.R],[a.X,a.Y]])).forEach((b,c)=>c.addEventListener("click",()=>b.bind(a)()));document.addEventListener("keydown",b=>{(b.ctrlKey||b.metaKey)&&"rs".includes(b.key)&&
(b.preventDefault(),"s"===b.key?a.R():"r"===b.key&&(window.scroll(0,0),l(a.s.js)))})}function A(a){a.store=JSON.parse(window.localStorage.getItem("snippets")||"[]");a.store.forEach(b=>B(a,b))}async function C(a,b){return a.store.find(c=>c.i===b)?(a.g=b,await D(window.localStorage.getItem("snippet-"+b))):{}}async function D(a){try{return Object.fromEntries(new URLSearchParams(await E(a).catch(()=>({}))))}catch(b){return console.error(b),{}}}
function F(a,b={}){document.title=a.j.value=b.t||"untitled";a.m={...a.Z,...JSON.parse(b.r||"{}")};a.L.forEach(c=>{let d=a.B.querySelector("."+c).classList;a.m[c]?d.add("on"):d.remove("on")});a.v.appendChild(a.B);["html","css"].forEach(c=>G(a,c,JSON.stringify({name:c,type:""}),b[c]||""));G(a,"js",JSON.stringify(a.m),b.js||"");a.$.appendChild(a.s.js.T);a.g&&(a.v.appendChild(a.l),a.l.firstChild.classList.remove("del-yes"))}function w(a){[a.K,a.I].forEach(b=>b.classList.toggle("hide"));return!0}
async function x(a,b){b=b.slice(b.lastIndexOf("#")+1);H(a);F(a,await C(a,b))}function y(a,b){let c=a.L.find(d=>b.classList.contains(d));a.m[c]=!a.m[c];b.classList.toggle("on");a.s.js.T.classList.toggle("snip-no"+c)}function z(a,b){switch(a.W.find(c=>b.classList.contains(c))){case "delete":b.classList.add("del-yes");break;case "del-yes":I(a);break;case "del-no":b.parentNode.classList.remove("del-yes")}}
...
function H(a){a.g&&a.l.remove();a.g="";a.B.remove();a.P.forEach(b=>{console.log("remove",b);m.remove(a.s[b].id);a.C[b]=null;a.J[b].remove()});a.s={};a.C={};a.J={}}function I(a){a.store.splice(a.store.findIndex(b=>b.i===a.g),1);J(a);a.H.querySelector("[href='#"+a.g+"']").parentNode.remove();window.localStorage.removeItem("snippet-"+a.g);a.O()}function K(a){[a.K,a.I].forEach(b=>b.classList.add("hide"))}
...
async function N(a,b=[]){return await L(a.P.map(c=>c+"="+encodeURIComponent(a.C[c].textarea.value)).concat([...b,"t="+encodeURIComponent(a.j.value),"r="+JSON.stringify(a.m)]).join("&"))}function J(a){window.localStorage.setItem("snippets",JSON.stringify(a.store))}function O(a){a.classList.add("yes");setTimeout(()=>a.classList.remove("yes"),500)}
class t{constructor(){this.P=["html","css","js"];this.L=["body","console"];this.W=["del-yes","del-no","delete"];this.Z={name:"js",type:"run",height:"18",body:!0,console:!0,insert:!1,js:[],css:[],link:["html","css"]};this.g="";this.m={};this.J={};this.s={};this.C={};this.store=[];this.A=document.querySelector(".header");this.v=document.querySelector(".content");this.K=document.querySelector(".menu");this.S=document.querySelector(".menutools");this.H=document.querySelector(".menulist");this.I=u(this.A,
"menubtn","hide");this.$=u(this.v,"wrap");this.j=document.createElement("input");this.j.placeholder="name...";this.j.classList.add("title");this.A.appendChild(this.j);u(this.A,"space");this.N=u(this.A,"save");this.X=u(this.A,"copy");this.create=u(this.S,"create");this.U=u(this.S,"about");this.B=u(null,"opts");this.L.forEach(b=>u(this.B,b,"opt"));this.l=u(null,"cmds");let a=u(this.l,"cmd","delete");u(a,"del-space");u(a,"cmd","del-no");v(this);this.start()}async start(){A(this);let a=location.hash.slice(1),
b={};8===a.length?b=await C(this,a):8<a.length&&(b=await D(a));F(this,b)}O(){K(this);H(this);F(this);M("")}async V(){K(this);H(this);F(this,await D(await (await fetch("about.snippet")).text()));M("")}async R(){if(this.g){var a=this.store.find(b=>b.i===this.g);if(a){a.t=this.j.value;let b=this.H.querySelector("[href='#"+this.g+"']");b&&(b.innerHTML=a.t)}}else a={i:Date.now().toString(36),t:this.j.value},this.g=a.i,document.title=a.t,this.store.push(a),B(this,a),this.v.appendChild(this.l),M(a.i);window.localStorage.setItem("snippet-"+
this.g,await N(this,["i="+this.g]));J(this);O(this.N)}async Y(){O(await navigator.clipboard.writeText(location.origin+location.pathname+"#"+await N(this)))}};}).call(this);
